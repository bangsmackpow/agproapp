 ...
 *
 *   pbkdf2Sync(password, Buffer.from('0123456789abcdef'), 210000, 32, 'sha256')
 *
 ...
 * either side's encoding drifts, this test fails rather than the first login.
 */
const NODE_GENERATED_HASH =
  'pbkdf2$sha256$210000$MDEyMzQ1Njc4OWFiY2RlZg$H_ZMdkjDEDpZ4T7DlMYQs7RkF9UgyowFSsi_pzKxi-s';
...
describe('verifyPassword', () => {
  ...
  it('returns false for malformed digests instead of throwing', async () => {
    const malformed = [
      '',
      'nonsense',
      'pbkdf2$sha256$210000$onlyfourparts',
      'argon2$sha256$210000$c2FsdA$aGFzaA',
